...
# ALGORITMO: Buscar el nombre de las vlan, el numero actual de la vlan, el numero propuesto,
# el tipo de servicio en el archivo vlan.csv y usando el nombre de vlan como campo clave
# obtenet el equipo y la interface a la que pertenece, creando el archivo .txt que 
# tenga lo necesario para mudar los clientes
